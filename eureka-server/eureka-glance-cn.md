...
*  用于使用Netflix [Asgard]的red/black部署(https://github.com/Netflix/asgard)——一个使云部署更容易的开源服务。Eureka与Asgard交互，以便在较旧/更新的服务部署版本之间快速无缝地切换，以防出现问题——特别是考虑到要启动100个实例来部署一个版本可能需要很长时间。
